            ...
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                ...
                <div className="w-full lg:w-8/12 lg:pt-8">
                    <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div className="w-55 p-2 pb-6 flex justify-center flex-col items-center">
                            <img src="https://i.ibb.co/FYTKDG6/Rectangle-118-2.png" alt="Alexa featured Img" />
                            ...
                            <p className="font-medium text-l leading-5 text-gray-800 mt-4">Founder & CEO</p>
                        </div>
                        <div className="w-58 p-2 pb-6 flex justify-center flex-col items-center">
                        ...
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p className="font-medium text-l leading-5 text-gray-800 mt-4">CFO</p>
                        </div>
                        <div className="p-4 pb-6 flex justify-center flex-col items-center">
                            ...
                            <p className="font-medium text-l leading-5 text-gray-800 mt-4">PMO</p>
                        </div>
                    </div>
                </div>
            </div>
